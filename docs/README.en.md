...
| [Community Market design](../dsh-community-market/README.md) | The shipped market shell, extensible catalog sources, user selection, install confirmation, and safety boundary |
| [Market catalog provider contract](../dsh-community-market/docs/catalog-provider-contract.md) | Schemas, query parameters, multi-source behavior, and adapter rules for catalog source providers |
