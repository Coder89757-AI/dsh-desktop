...
Now that the plugin marketplace ships, plugins that follow this manifesto are easier to discover, install, and trust. We want convention-driven development to be the beneficial choice for every author, not an extra burden.
...
The market [ships inside Desktop](../dsh-community-market/README.md) with discovery, install, and management views. Catalog inclusion means that a project matched catalog rules; it is not a security review or endorsement.
