...
插件市场已上线，符合本倡议的插件将更容易被发现、安装和信任。我们希望让"按规范开发"成为对每个作者都有利的选择，而不是额外的负担。
...
市场已内置在 Desktop 中，可在[插件市场](../dsh-community-market/README.zh.md)查看发现、安装与管理页面。目录收录只代表符合目录规则，不等于安全审核或推荐。
