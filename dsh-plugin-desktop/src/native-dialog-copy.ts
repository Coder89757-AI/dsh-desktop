...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    dismiss: 'Dismiss',
    updateAvailableTitle: '法海问津 Update Available',
    updateAvailableMessage: version => `法海问津 ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside 法海问津 Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: '法海问津 Is Up to Date',
    ...
    updateDownloadedTitle: '法海问津 Update Downloaded',
    updateReady: version => `法海问津 ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace 法海问津 in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart 法海问津 and run the installer now?',
    ...
    updateInstalled: version => `法海问津 ${version} has been installed.`,
  ...
  zh: {
    ...
    restart: '重启 法海问津',
    dismiss: '关闭',
    updateAvailableTitle: '法海问津 有可用更新',
    updateAvailableMessage: version => `法海问津 ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？法海问津 Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: '法海问津 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: '法海问津 更新已下载',
    updateReady: version => `法海问津 ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 法海问津，然后重新打开。',
    windowsInstallQuestion: '现在重启 法海问津 并运行安装程序？',
    ...
    updateInstalled: version => `法海问津 ${version} 已安装。`,
