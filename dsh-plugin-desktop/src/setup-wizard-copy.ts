...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up Lexford',
    profile: 'Profile',
    welcomeTitle: 'Welcome to Lexford',
    ...
    communityMarketBody: 'The open market built into Lexford, including custom data sources.',
    ...
    startUsing: 'Start using Lexford',
  ...
  zh: {
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'Lexford 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
