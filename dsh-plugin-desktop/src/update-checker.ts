/** Headless version checks against the public Lexford release service. */
...
/** Public endpoint returning the latest Lexford version for a requested channel. */
...
/**
 * Check the fixed Lexford version endpoint for a release in one channel.
