...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\Lexford\\Lexford.exe',
  upstreamRunner: 'C:\\Program Files\\Lexford\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\Lexford\\resources\\app.asar\\desktop-runner.js',
}
