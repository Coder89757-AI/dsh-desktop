window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		//#endregion
		//#region src/client/LegalKbFooterAction.tsx
		...
		function formatExpiry(expiresAt, t) {
			return (/* @__PURE__ */ new Date(expiresAt * 1e3)).toLocaleString(void 0, {
				year: "numeric",
				month: "2-digit",
				day: "2-digit"
			}) || t("identityPermanent");
		...
		function LegalKbFooterAction({ api, t, wide }) {
			...
			const refresh = (0, react.useCallback)(async (fetcher = api) => {
			...
			(0, react.useEffect)(() => {
				if (!panelOpen || status !== void 0) return;
				refresh().catch(() => {
					setLoadFailed(true);
				});
			}, [
			...
			const activate = () => {
				...
				if (trimmed.length === 0 || busy !== void 0) return;
				setBusy("activate");
				setError(null);
				(async () => {
					if (status?.connected === true) await api.disconnect().catch(() => {});
					const next = await api.activate(trimmed);
					setStatus(next);
					setCode("");
					setShowAdvanced(false);
				})().catch((cause) => {
					setError(cause instanceof Error && cause.message.length > 0 && !cause.message.startsWith("dsh-plugin-desktop:") ? cause.message : t("activateFailed"));
				}).finally(() => {
					setBusy(void 0);
				});
			};
			const disconnect = () => {
				...
				setBusy("disconnect");
				setError(null);
				api.disconnect().then(() => refresh()).catch(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						"aria-hidden": "true",
						className: "dshLegalKbLauncherIcon"
					}),
					wide && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dshLegalKbLauncherLabel",
						children: t("title")
					}),
					wide && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dshLegalKbLauncherState",
						"data-on": connected ? "true" : "false",
						"aria-hidden": "true"
					})
				]
			}), panelOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dshLegalKbBackdrop",
				role: "presentation",
				onClick: (event) => {
					if (event.target === event.currentTarget) setPanelOpen(false);
				},
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dshLegalKbPanel",
					role: "dialog",
					"aria-modal": "true",
					"aria-label": t("title"),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							className: "dshLegalKbPanelHeader",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									"aria-hidden": "true",
									className: "dshLegalKbHeaderIcon"
								}),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(import_lucide_react.X, { "aria-hidden": "true" })
								})
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "dshLegalKbIntro",
							children: t("intro")
						}),
						loadFailed && status === void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "dshLegalKbError",
							role: "alert",
							children: t("loadFailed")
						}),
						!loadFailed && status !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dshLegalKbState",
							"data-connected": connected ? "true" : "false",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshLegalKbStateBadge",
								children: connected ? t("connected") : t("notConnected")
							}), connected && identity !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("dl", {
								className: "dshLegalKbIdentity",
								children: [
									identity.name !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("identityName") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: identity.name })] }),
									identity.org !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("identityOrg") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: identity.org })] }),
									identity.credits !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("identityCredits") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatCredits(identity.credits) })] }),
									identity.expiresAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: t("identityExpires") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: formatExpiry(identity.expiresAt, t) })] })
								]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
							className: "dshLegalKbForm",
							onSubmit: (event) => {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									className: "dshLegalKbField",
									children: [t("licenseCode"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "dshLegalKbAdvancedToggle",
								...
								showAdvanced && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dshLegalKbAdvanced",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: "dshLegalKbField",
										children: [t("apiUrl"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											className: "dshLegalKbInput",
											value: apiUrl,
											onChange: (event) => {
										...
										className: "dshLegalKbField",
										children: [t("mcpUrl"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											className: "dshLegalKbInput",
											value: mcpUrl,
											onChange: (event) => {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dshLegalKbActions",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "submit",
										className: "dshLegalKbPrimary",
										disabled: code.trim().length === 0 || busy !== void 0,
										children: busy === "activate" ? t("activating") : t("activate")
									}), connected && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: "dshLegalKbSecondary",
										disabled: busy !== void 0,
										onClick: disconnect,
										children: busy === "disconnect" ? t("disconnecting") : t("disconnect")
									})]
								})
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: "dshLegalKbHint",
		...
		//#endregion
		//#region src/client/legal-kb-api.ts
		...
		function parseIdentity(value) {
			...
			if (!isObject(value) || typeof value.licenseId !== "string" || typeof value.name !== "string" || typeof value.org !== "string" || typeof value.role !== "string" || value.credits !== null && typeof value.credits !== "number" || value.expiresAt !== null && typeof value.expiresAt !== "number") throw new Error("dsh-plugin-desktop: invalid Legal-KB identity response");
			return {
		...
		function parseLegalKbStatus(value) {
			if (!isObject(value) || typeof value.apiUrl !== "string" || typeof value.mcpUrl !== "string" || typeof value.connected !== "boolean" || value.lastError !== null && typeof value.lastError !== "string") throw new Error("dsh-plugin-desktop: invalid Legal-KB status response");
			return {
				apiUrl: value.apiUrl,
				mcpUrl: value.mcpUrl,
		...
		function createLegalKbApi(fetcher = globalThis.fetch.bind(globalThis)) {
			return Object.freeze({
				async status() {
					return parseLegalKbStatus(await readResponse(await fetcher(STATUS_PATH, {
						method: "GET",
				...
				async activate(code) {
					...
					if (!response.ok) {
						const message = isObject(value) && typeof value.error === "string" ? value.error : void 0;
				...
				async disconnect() {
					...
					if (!response.ok) throw new Error(`dsh-plugin-desktop: Legal-KB disconnect failed (${String(response.status)})`);
				}
			});
		}
		//#endregion
		//#region src/client/legal-kb-locales.ts
		...
		//#endregion
		//#region src/client/legal-kb-icon.ts
		/** Legal-KB sidebar icon: the supplied SVG artwork reduced to geometry and
		* inlined as a data URI. Render via CSS mask + currentColor so the fill follows
		* the theme label color; vector geometry stays sharp at any scale. */
		const legalKbIconSvgDataUri = "data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%201024%201024%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%3Cpath%20d%3D%22M952.832%20844.448c21.664%200%2039.168%2018.656%2039.168%2041.76%200%2023.136-17.504%2041.792-39.168%2041.792H71.168C49.504%20928%2032%20909.344%2032%20886.208c0-23.104%2017.504-41.76%2039.168-41.76h881.664zM762.208%20106.496c85.28%2013.952%20155.392%2036.672%20158.304%2037.6%2017.28%205.6%2028.992%2021.664%2028.992%2039.68v553.6a41.888%2041.888%200%200%201-42.048%2041.792%2044.8%2044.8%200%200%201-13.568-2.24c-126.944-42.56-220.288-42.176-276.16-34.336-55.232%207.712-83.712%2023.776-83.968%2023.904a42.56%2042.56%200%200%201-6.432%203.168l4.064-1.984a44.064%2044.064%200%200%201-5.728%202.56c-0.48%200.192-0.96%200.32-1.472%200.48a41.12%2041.12%200%200%201-35.136-4.096c-2.624-1.44-33.088-17.6-89.76-24.8-55.104-6.944-146.72-6.528-270.496%2034.976a41.28%2041.28%200%200%201-13.568%202.368c-8.704%200-17.28-2.624-24.64-7.84a41.536%2041.536%200%200%201-17.536-33.952v-553.6c0-18.016%2011.712-34.08%2028.992-39.68%202.88-0.928%2073.024-23.776%20158.304-37.6%20110.208-17.92%20194.528-12.896%20250.976%2015.072%2056.384-27.968%20140.672-32.96%20250.88-15.072zM274.08%20189.024a1117.44%201117.44%200%200%200-116.672%2025.824V680.96c93.312-25.056%20180.32-32.096%20259.296-20.992%2019.776%202.72%2037.024%206.4%2051.808%2010.432V193.984c-39.808-17.248-107.84-19.072-194.432-4.96z%20m280.096%204.96V670.4a460.576%20460.576%200%200%201%2051.84-10.432c24.096-3.424%2049.024-5.12%2074.56-5.12%2058.144%200%20119.84%208.768%20184.704%2026.112V214.848a1103.584%201103.584%200%200%200-117.728-26.112c-86.08-13.952-153.824-12-193.376%205.248z%22%3E%3C%2Fpath%3E%3C%2Fsvg%3E";
		//#endregion
		//#region src/client/legal-kb-styles.ts
...
`;
		...
		//#endregion
		//#region src/client/legal-kb.ts
		/** Locale namespace owned by the Legal-KB entry. */
		const LEGAL_KB_LOCALE_NAMESPACE = "legal-kb";
		/** Register the Legal-KB entry in the sidebar footer action list slot. */
		function applyLegalKb(ctx) {
			const api = createLegalKbApi();
			ctx.effect(() => ctx.locale.register(LEGAL_KB_LOCALE_NAMESPACE, {
				zh,
				en
			}), "dsh-plugin-desktop: legal-kb dictionaries");
			ctx.effect(() => installLegalKbStyles(), "dsh-plugin-desktop: legal-kb styles");
		...
		//#endregion
		exports.apply = apply;
		exports.applyLegalKb = applyLegalKb;
