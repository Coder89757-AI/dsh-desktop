...
export declare const SKILL_MANAGER_STATE_PATH = "/_dsh/skill-manager/state";
/** Same-origin route persisting one MCP server entry. */
export declare const SKILL_MANAGER_MCP_SAVE_PATH = "/_dsh/skill-manager/mcp/save";
/** Same-origin route removing one MCP server entry. */
export declare const SKILL_MANAGER_MCP_REMOVE_PATH = "/_dsh/skill-manager/mcp/remove";
/** Same-origin route enabling or disabling one MCP server. */
export declare const SKILL_MANAGER_MCP_TOGGLE_PATH = "/_dsh/skill-manager/mcp/toggle";
/** Same-origin route probing one MCP server entry with a live connection. */
export declare const SKILL_MANAGER_MCP_TEST_PATH = "/_dsh/skill-manager/mcp/test";
/** Same-origin route listing the tools one MCP server entry publishes. */
export declare const SKILL_MANAGER_MCP_TOOLS_PATH = "/_dsh/skill-manager/mcp/tools";
/** Same-origin route enabling or disabling one skill. */
export declare const SKILL_MANAGER_SKILL_TOGGLE_PATH = "/_dsh/skill-manager/skills/toggle";
/** Same-origin route saving (creating or updating) a user skill. */
export declare const SKILL_MANAGER_SKILL_SAVE_PATH = "/_dsh/skill-manager/skills/save";
/** Same-origin route deleting a user skill. */
export declare const SKILL_MANAGER_SKILL_DELETE_PATH = "/_dsh/skill-manager/skills/delete";
/** Same-origin route importing skills from a picked directory. */
export declare const SKILL_MANAGER_SKILL_IMPORT_PATH = "/_dsh/skill-manager/skills/import";
/** Same-origin route reading one skill's full SKILL.md content. */
export declare const SKILL_MANAGER_SKILL_READ_PATH = "/_dsh/skill-manager/skills/read";
